  ...
  const yearFifteen = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600);
  ...
  const peopleSort = people.sort(function(firstName,lastName){
  ...
  const reduceType = data.reduce(function(obj,item) {
    if(!obj[item]){
      obj[item]=0;
    }
    obj[item]++;
